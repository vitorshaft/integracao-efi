...
app.get("/consulta-Maquina01", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var valorAux = 0;
    var ticket = 1;
...
app.get("/consulta-maquina-02", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post("/rota-recebimento", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.post("/rota-recebimento-teste", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
function calcularCRC16(str, invert = false) {
...
function notificar(urlDiscordWebhook, txid, valor) {
